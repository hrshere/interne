!(function (e, t) {
                        ...
                        (n = e[t]),
                            "__proto__" !== t &&
                                ...
                                (l && n && (T.isPlainObject(n) || (i = Array.isArray(n)))
                                    ? ((o = r[t]), (o = i && !Array.isArray(o) ? [] : i || T.isPlainObject(o) ? o : {}), (i = !1), (r[t] = T.extend(l, o, n)))
                                    : void 0 !== n && (r[t] = n));
            return r;
        }),
        T.extend({
            ...
            each: function (e, t) {
                var n,
                    i = 0;
                if (Y(e)) for (n = e.length; i < n && !1 !== t.call(e[i], i, e[i]); i++);
            ...
            map: function (e, t, n) {
                var i,
                    ...
                    r = 0,
                    s = [];
                if (Y(e)) for (i = e.length; r < i; r++) null != (o = t(e[r], r, n)) && s.push(o);
    ...
    var e = (function (M) {
                ...
                if (!i && (x(e), (e = e || T), k)) {
                    ...
                    if (f.qsa && !m[t + " "] && (!p || !p.test(t)) && (1 !== d || "object" !== e.nodeName.toLowerCase())) {
                        if (((c = t), (u = e), 1 === d && (ie.test(t) || ne.test(t)))) {
                            for (((u = (ue.test(t) && me(e.parentNode)) || e) === e && f.scope) || ((s = e.getAttribute("id")) ? (s = s.replace(de, H)) : e.setAttribute("id", (s = C))), r = (l = h(t)).length; r--; )
                                l[r] = (s ? "#" + s : ":scope") + " " + P(l[r]);
                            c = l.join(",");
                        }
                        try {
            ...
            (x = L.setDocument = function (e) {
                ...
                return (
                    e != T &&
                        ...
                        (k = !R(T)),
                        u != T && (e = T.defaultView) && e.top !== e && (e.addEventListener ? e.addEventListener("unload", q, !1) : e.attachEvent && e.attachEvent("onunload", q)),
                        ...
                        (f.getElementsByClassName = S.test(T.getElementsByClassName)),
                        ...
                        (f.qsa = S.test(T.querySelectorAll)) &&
                            (j(function (e) {
                                ...
                                (n.appendChild(e).innerHTML = "<a id='" + C + "'></a><select id='" + C + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                                    ...
                                    e.querySelectorAll("[selected]").length || p.push("\\[" + s + "*(?:value|" + K + ")"),
                        ...
                        (f.matchesSelector = S.test((o = n.matches || n.webkitMatchesSelector || n.mozMatchesSelector || n.oMatchesSelector || n.msMatchesSelector))) &&
                            j(function (e) {
            ...
            (L.matchesSelector = function (e, t) {
                if ((x(e), f.matchesSelector && k && !m[t + " "] && (!i || !i.test(t)) && (!p || !p.test(t))))
                    try {
                        var n = o.call(e, t);
            ...
            ((_ = L.selectors = {
                ...
                preFilter: {
                    ...
                    PSEUDO: function (e) {
                        ...
                        return b.CHILD.test(e[0])
                            ? null
                            : (e[3] ? (e[2] = e[4] || e[5] || "") : n && oe.test(n) && (t = h(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
                    },
                },
                filter: {
                    TAG: function (e) {
                            ...
                            : function (e, t, n) {
                                  ...
                                  if (u) {
                                      ...
                                      if (((l = [y ? u.firstChild : u.lastChild]), y && f)) {
                                          for (
                                              h = (a = (i = (o = (r = (s = u)[C] || (s[C] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === A && i[1]) && i[2], s = a && u.childNodes[a];
                                          ...
                                          for (
                                              ;
                                              (s = (++a && s && s[c]) || (h = a = 0) || l.pop()) &&
                                              ((b ? s.nodeName.toLowerCase() !== d : 1 !== s.nodeType) || !++h || (f && ((o = (r = s[C] || (s[C] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] = [A, h]), s !== e));
                    ...
                    PSEUDO: function (e, r) {
                        var t,
                            s = _.pseudos[e] || _.setFilters[e.toLowerCase()] || L.error("unsupported pseudo: " + e);
                        return s[C]
                            ? s(r)
                            : 1 < s.length
                            ? ((t = [e, e, "", r]),
                ...
                pseudos: {
                    ...
                    lang: N(function (n) {
                        return (
                            re.test(n || "") || L.error("unsupported lang: " + n),
                ...
                return (
                    ...
                    N(function (e, t, n, i) {
                        var o,
                            ...
                            f = g ? (v || (e ? h : c || m) ? [] : t) : d;
                        if ((g && g(d, f, n, i), m)) for (o = _e(f, l), m(o, [], n, i), r = o.length; r--; ) (s = o[r]) && (f[l[r]] = !(d[l[r]] = s));
                        if (e) {
                            if (v || h) {
                                if (v) {
            ...
            return (
                ...
                (h = L.tokenize = function (e, t) {
                    ...
                    for (s = e, a = [], l = _.preFilter; s; ) {
                        ...
                        (n = !1),
                        (i = ne.exec(s)) && ((n = i.shift()), o.push({ value: n, type: i[0].replace(v, " ") }), (s = s.slice(n.length))),
                        _.filter))
                            !(i = b[r].exec(s)) || (l[r] && !(i = l[r](i))) || ((n = i.shift()), o.push({ value: n, type: r, matches: i }), (s = s.slice(n.length)));
                        if (!n) break;
                    }
                                ...
                                for (
                                    ...
                                    if ((n = _.relative[t[l].type])) d = [ye(be(d), n)];
                                        ...
                                        if ((n = _.filter[t[l].type].apply(null, t[l].matches))[C]) {
                                            ...
                                            return we(
                                                1 < l && be(d),
                                                1 < l && P(t.slice(0, l - 1).concat({ value: " " === t[l - 2].type ? "*" : "" })).replace(v, "$1"),
                                                n,
                                                l < o && e(t.slice(l, o)),
                                                o < r && e((t = t.slice(o))),
                                                o < r && P(t)
                ...
                (f.sortStable = C.split("").sort(X).join("") === C),
                                            ...
                                            (t = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                y(t)
                                                    ? a
                                                        ...
                                                        : (l++, t.call(e, c(l, r, u, a), c(l, r, oe, a), c(l, r, u, r.notifyWith)))
                                                    : (s !== u && ((n = void 0), (i = [e])), (a || r.resolveWith)(n, i));
                                        }
                                    }
                                    var n = this,
                                        i = arguments,
    ...
    (T.fn.ready = function (e) {
        ...
        "complete" === x.readyState || ("loading" !== x.readyState && !x.documentElement.doScroll) ? w.setTimeout(T.ready) : (x.addEventListener("DOMContentLoaded", le), w.addEventListener("load", le));
    function d(e, t, n, i, o, r, s) {
        var a = 0,
            l = e.length,
            c = null == n;
        if ("object" === p(n)) for (a in ((o = !0), n)) d(e, t, a, n[a], !0, r, s);
        else if (
            void 0 !== i &&
            ((o = !0),
            y(i) || (s = !0),
    ...
    function be(e, t, n, i) {
        ...
        if (u && u[3] !== c) {
            for (c = c || u[3], u = +(l /= 2) || 1; s--; ) T.style(e, t, u + c), (1 - r) * (1 - (r = a() / l || 0.5)) <= 0 && (s = 0), (u /= r);
    ...
    function E(e, t) {
        for (var n, i, o, r, s, a = [], l = 0, c = e.length; l < c; l++)
            (i = e[l]).style &&
                ((n = i.style.display),
                t
                    ? ("none" === n && ((a[l] = _.get(i, "display") || null), a[l] || (i.style.display = "")),
                      "" === i.style.display &&
                          me(i) &&
                          (a[l] =
                              ((s = r = void 0),
                              (r = (o = i).ownerDocument),
                              (o = o.nodeName),
                              (s = _e[o]) || ((r = r.body.appendChild(r.createElement(o))), (s = T.css(r, "display")), r.parentNode.removeChild(r), (_e[o] = s = "none" === s ? "block" : s)))))
    ...
    var we = /^(?:checkbox|radio)$/i,
        ...
        S =
            ...
            (r = x.createElement("input")).setAttribute("type", "radio"),
    ...
    function Ae(e, t, n, i, o) {
        ...
        for (u.textContent = "", f = 0; (r = d[f++]); )
            ...
            else if (((l = A(r)), (s = D(u.appendChild(r), "script")), l && ke(s), n)) for (c = 0; (r = s[c++]); ) Te.test(r.type || "") && n.push(r);
        return u;
    }
    var Ee = /^([^.]*)(?:\.(.+)|)/;
    function n() {
              ...
              T.event.add(e, o, {
                  ...
                  handler: function (e) {
                      ...
                      if (1 & e.isTrigger && this[o]) {
                          ...
                          else if (((i = a.call(arguments)), _.set(this, o, i), (t = r(this, o)), this[o](), i !== (n = _.get(this, o)) || t ? _.set(this, o, !1) : (n = {}), i !== n))
                              return e.stopImmediatePropagation(), e.preventDefault(), n && n.value;
                      } else i.length && (_.set(this, o, { value: T.event.trigger(T.extend(i[0], T.Event.prototype), i.slice(1), this) }), e.stopImmediatePropagation());
                  },
              }))
    ...
    (T.event = {
                ...
                for (
                    ...
                    (d = h = (f = Ee.exec(e[l]) || [])[1]),
                        ...
                        d &&
                            ...
                            (c = T.event.special[d] || {}),
                            (h = T.extend({ type: d, origType: h, data: i, handler: n, guid: n.guid, selector: o, needsContext: o && T.expr.match.needsContext.test(o), namespace: f.join(".") }, r)),
        ...
        dispatch: function (e) {
            ...
            if (((a.delegateTarget = this), !l.preDispatch || !1 !== l.preDispatch.call(this, a))) {
                for (r = T.event.handlers.call(this, a, e), t = 0; (i = r[t++]) && !a.isPropagationStopped(); )
                    for (a.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !a.isImmediatePropagationStopped(); )
                        (a.rnamespace && !1 !== o.namespace && !a.rnamespace.test(o.namespace)) ||
                            ((a.handleObj = o), (a.data = o.data), void 0 !== (o = ((T.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) && !1 === (a.result = o) && (a.preventDefault(), a.stopPropagation()));
        ...
        (T.Event = function (e, t) {
            ...
            e && e.type
                ? ((this.originalEvent = e),
                  (this.type = e.type),
                  (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? n : h),
    ...
    function He(e, t) {
        var n, i, o, r;
        if (1 === t.nodeType) {
            if (_.hasData(e) && (r = _.get(e).events)) for (o in (_.remove(t, "handle events"), r)) for (n = 0, i = r[o].length; n < i; n++) T.event.add(t, o, r[o][n]);
    ...
    function L(n, i, o, r) {
        ...
        var e,
            ...
            h = i[0],
            p = y(h);
        if (p || (1 < d && "string" == typeof h && !m.checkClone && Ne.test(h)))
                ...
                for (c = s[s.length - 1].ownerDocument, T.map(s, Me), u = 0; u < a; u++)
                    (l = s[u]),
                        Te.test(l.type || "") &&
                            ...
                            T.contains(c, l) &&
                            (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && !l.noModule && T._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }, c) : U(l.textContent.replace(je, ""), l, c));
        }
        return n;
    }
    function qe(e, t, n) {
    ...
    T.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(m.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || T.isXMLDoc(e)))
                for (s = D(u), i = 0, o = (r = D(e)).length; i < o; i++)
                    (a = r[i]), (l = s[i]), (c = void 0), "input" === (c = l.nodeName.toLowerCase()) && we.test(a.type) ? (l.checked = a.checked) : ("input" !== c && "textarea" !== c) || (l.defaultValue = a.defaultValue);
            if (t)
                if (n) for (r = r || D(e), s = s || D(u), i = 0, o = r.length; i < o; i++) He(r[i], s[i]);
                else He(e, u);
    ...
    function Je() {
        ...
        o &&
            ...
            C.appendChild(Ue).appendChild(o),
    ...
    function et(e, t, n) {
        ...
        return (
            (n = n || Re(e)) &&
                ...
                "" !== (i = o ? i.replace(Ke, "$1") : i) || A(e) || (i = T.style(e, t)),
                !m.pixelBoxStyles() && Ye.test(i) && Ge.test(t) && ((o = r.width), (e = r.minWidth), (t = r.maxWidth), (r.minWidth = r.maxWidth = r.width = i), (i = n.width), (r.width = o), (r.minWidth = e), (r.maxWidth = t))),
            void 0 !== i ? i + "" : i
        );
    }
    function tt(e, t) {
                ...
                reliableTrDimensions: function () {
                    ...
                    return (
                        null == Ve &&
                            ...
                            (Ve = parseInt(n.height, 10) + parseInt(n.borderTopWidth, 10) + parseInt(n.borderBottomWidth, 10) === t.offsetHeight),
                            C.removeChild(e)),
                        Ve
                    );
                },
    ...
    function ut(e, t, n, i, o, r) {
        ...
        for (; s < 4; s += 2)
            "margin" === n && (l += T.css(e, n + f[s], !0, o)),
                i
                    ? ("content" === n && (l -= T.css(e, "padding" + f[s], !0, o)), "margin" !== n && (l -= T.css(e, "border" + f[s] + "Width", !0, o)))
                    : ((l += T.css(e, "padding" + f[s], !0, o)), "padding" !== n ? (l += T.css(e, "border" + f[s] + "Width", !0, o)) : (a += T.css(e, "border" + f[s] + "Width", !0, o)));
    ...
    function dt(e, t, n) {
        ...
        return (
            ...
            (s = parseFloat(s) || 0) + ut(e, t, n || (o ? "border" : "content"), r, i, s) + "px"
        );
    }
    ...
    T.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" === (r = typeof n) && (o = ve.exec(n)) && o[1] && ((n = be(e, t, o)), (r = "number")),
                    null != n &&
                        n == n &&
        ...
        css: function (e, t, n, i) {
            ...
            return (
                Qe.test(t) || (t = rt(r)),
                "normal" === (o = void 0 === (o = (r = T.cssHooks[t] || T.cssHooks[r]) && "get" in r ? r.get(e, !0, n) : o) ? et(e, t, i) : o) && t in lt && (o = lt[t]),
            ...
            T.cssHooks[s] = {
                ...
                set: function (e, t, n) {
                    var i = Re(e),
                        ...
                        n = n ? ut(e, s, n, r, i) : 0;
                    return (
                        r && o && (n -= Math.ceil(e["offset" + s[0].toUpperCase() + s.slice(1)] - parseFloat(i[s]) - ut(e, s, "border", !1, i) - 0.5)),
                        n && (r = ve.exec(t)) && "px" !== (r[3] || "px") && ((e.style[s] = t), (t = T.css(e, s))),
                        ct(0, t, n)
                    );
                },
            };
    ...
    function j(o, e, t) {
        ...
        for (; u < d; u++) if ((n = j.prefilters[u].call(p, o, g, p.opts))) return y(n.stop) && (T._queueHooks(p.elem, p.opts.queue).stop = n.stop.bind(n)), n;
        return (
            T.map(g, yt, p),
            ...
            T.fx.timer(T.extend(h, { elem: o, anim: p, queue: p.opts.queue })),
            p
        );
    }
            ...
            function (e, t, n) {
                ...
                if ((l = !T.isEmptyObject(t)) || !T.isEmptyObject(f))
                    for (i in (u &&
                        ...
                        "none" === (u = T.css(e, "display")) && (c ? (u = c) : (E([e], !0), (c = e.style.display || c), (u = T.css(e, "display")), E([e]))),
                    ...
                    f))
                        l ||
                            (g ? "hidden" in g && (p = g.hidden) : (g = _.access(e, "fxshow", { display: c })),
                            r && (g.hidden = !p),
                            p && E([e], !0),
                            d.done(function () {
                ...
                attr: function (e, t, n) {
                    ...
                    if (3 !== r && 8 !== r && 2 !== r)
                        return void 0 === e.getAttribute
                            ? T.prop(e, t, n)
                            : ((1 === r && T.isXMLDoc(e)) || (o = T.attrHooks[t.toLowerCase()] || (T.expr.match.bool.test(t) ? bt : void 0)),
                              void 0 !== n
                                  ? null === n
        ...
        T.fn.extend({
            ...
            toggleClass: function (t, n) {
                ...
                return y(t)
                    ...
                    : ((e = Tt(t)),
                      this.each(function () {
                          if (a) for (r = T(this), o = 0; o < e.length; o++) (i = e[o]), r.hasClass(i) ? r.removeClass(i) : r.addClass(i);
            ...
            hasClass: function (e) {
                for (var t, n = 0, i = " " + e + " "; (t = this[n++]); ) if (1 === t.nodeType && -1 < (" " + I(P(t)) + " ").indexOf(i)) return !0;
                return !1;
            },
        });
    function kt(e) {
                        ...
                        return (
                            ...
                            i ||
                                ...
                                (a &&
                                    ...
                                    ((r = n[a]) && (n[a] = null),
                                    (T.event.triggered = f),
                                    e.isPropagationStopped() && u.addEventListener(f, kt),
                                    n[f](),
                                    e.isPropagationStopped() && u.removeEventListener(f, kt),
    ...
    (zt.href = Et.href),
        T.extend({
            ...
            ajax: function (e, t) {
                ...
                (c = p.url.replace(Pt, "")),
                p.hasContent
                    ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(It, "+"))
                    : ((e = p.url.slice(c.length)),
                      p.data && (p.processData || "string" == typeof p.data) && ((c += (Dt.test(c) ? "&" : "?") + p.data), delete p.data),
                      !1 === p.cache && ((c = c.replace(Mt, "$1")), (e = (Dt.test(c) ? "&" : "?") + "_=" + St.guid++ + e)),
                      (p.url = c + e)),
                    ...
                    f ||
                        ...
                        i
                            ? (p.ifModified && ((n = _.getResponseHeader("Last-Modified")) && (T.lastModified[c] = n), (n = _.getResponseHeader("etag")) && (T.etag[c] = n)),
                              204 === e || "HEAD" === p.type ? (a = "nocontent") : 304 === e ? (a = "notmodified") : ((a = s.state), (o = s.data), (i = !(r = s.error))))
                        ...
                        _.statusCode(b),
                        (b = void 0),
                        h && m.trigger(i ? "ajaxSuccess" : "ajaxError", [_, p, i ? o : r]),
                        y.fireWith(g, [_, a]),
        ...
        T.each(["get", "post"], function (e, o) {
            T[o] = function (e, t, n, i) {
                return y(t) && ((i = i || n), (n = t), (t = void 0)), T.ajax(T.extend({ url: e, type: o, dataType: i, data: t, success: n }, T.isPlainObject(e) && e));
            };
        }),
    ...
    var Ut = { 0: 200, 1223: 204 },
        ...
        Kt =
            ...
            (m.createHTMLDocument = (((r = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === r.childNodes.length)),
            (T.parseHTML = function (e, t, n) {
                return "string" != typeof e
                    ...
                    : ("boolean" == typeof t && ((n = t), (t = !1)),
                      ...
                      (i = !n && []),
                      (n = K.exec(e)) ? [t.createElement(n[1])] : ((n = Ae([e], t, i)), i && i.length && T(i).remove(), T.merge([], n.childNodes)));
                var i;
            }),
            ...
            (T.offset = {
                setOffset: function (e, t, n) {
                    ...
                    "static" === a && (e.style.position = "relative"),
                        ...
                        null != (t = y(t) ? t.call(e, n, T.extend({}, r)) : t).top && (c.top = t.top - r.top + o),
    ...
    (function (e, t) {
                    ...
                    const v = e
                        ? ((d = i),
                          ...
                          function t(n) {
                              ...
                              for (let e = n["target"]; e && e !== this; e = e.parentNode) for (const o of i) if (o === e) return le(n, { delegateTarget: e }), t.oneOff && y.off(d, n.type, f, h), h.apply(e, [n]);
                          })
                        : ((c = i),
                          (u = t),
                          function e(t) {
                              return le(t, { delegateTarget: c }), e.oneOff && y.off(c, t.type, u), u.apply(c, [t]);
                          });
        ...
        const y = {
            ...
            trigger(e, t, n) {
                ...
                let o = null,
                    ...
                    s = !0,
                    a = !1,
                    l = (t !== ae(t) && i && ((o = i.Event(t, n)), i(e).trigger(o), (r = !o.isPropagationStopped()), (s = !o.isImmediatePropagationStopped()), (a = o.isDefaultPrevented())), new Event(t, { bubbles: r, cancelable: !0 }));
        ...
        class fe {
            ...
            _mergeConfigObj(e, t) {
                ...
                return { ...this.constructor.Default, ...("object" == typeof n ? n : {}), ...(s(t) ? d.getDataAttributes(t) : {}), ...("object" == typeof e ? e : {}) };
            }
        ...
        class be extends fe {
            ...
            _initEvents() {
                this._supportPointerEvents
                    ? (y.on(this._element, "pointerdown.bs.swipe", (e) => this._start(e)), y.on(this._element, "pointerup.bs.swipe", (e) => this._end(e)), this._element.classList.add("pointer-event"))
                    : (y.on(this._element, "touchstart.bs.swipe", (e) => this._start(e)), y.on(this._element, "touchmove.bs.swipe", (e) => this._move(e)), y.on(this._element, "touchend.bs.swipe", (e) => this._end(e)));
            }
        ...
        const Te = "carousel",
            ...
            Ae = ".carousel-item";
        Ce, Ae;
        const Ee = { ArrowLeft: we, ArrowRight: g },
                ...
                if (!this._isSliding) {
                    ...
                    if (o !== i) {
                        const r = this._getItemIndex(o),
                            s = (e) => y.trigger(this._element, e, { relatedTarget: o, direction: this._orderToDirection(t), from: this._getItemIndex(i), to: r });
        ...
        y.on(document, "click.bs.collapse.data-api", je, function (e) {
            ...
            e = R(this);
            for (const t of f.find(e)) Me.getOrCreateInstance(t, { toggle: !1 }).toggle();
        }),
            e(Me);
        var E = "top",
            S = "bottom",
        ...
        function tt(e, t) {
            ...
            var n = e.getBoundingClientRect(),
                ...
                o = 1;
            return (
                w(e) && t && ((t = e.offsetHeight), 0 < (e = e.offsetWidth) && (i = et(n.width) / e || 1), 0 < t && (o = et(n.height) / t || 1)),
        ...
        function st(e) {
            ...
            return (
                ((!i || ("html" !== v(i) && ("body" !== v(i) || "static" !== x(i).position))) &&
                    (i ||
                        (function (e) {
        ...
        var ft = {
            ...
            fn: function (e) {
                ...
                a &&
                    ...
                    ((e = e.padding),
                    (n = r),
                    (n = ut("number" != typeof (e = "function" == typeof e ? e(Object.assign({}, n.rects, { placement: n.placement })) : e) ? e : dt(e, O))),
                    (e = nt(a)),
                    (o = "y" === c ? E : L),
                    (i = "y" === c ? S : D),
                    (t = r.rects.reference[u] + r.rects.reference[c] - l[c] - r.rects.popper[u]),
                    (l = l[c] - r.rects.reference[c]),
                    (a = (a = st(a)) ? ("y" === c ? a.clientHeight || 0 : a.clientWidth || 0) : 0),
                    (o = n[o]),
                    (n = a - e[u] - n[i]),
                    (o = lt(o, (i = a / 2 - e[u] / 2 + (t / 2 - l / 2)), n)),
                    (r.modifiersData[s] = (((a = {})[c] = o), (a.centerOffset = o - i), a)));
            },
            effect: function (e) {
                var t = e.state;
            ...
            var t,
                ...
                o =
                    (d &&
                        ((n = "clientHeight"),
                        (t = "clientWidth"),
                        (i = st(o)) === _(o) && "static" !== x((i = T(o))).position && "absolute" === c && ((n = "scrollHeight"), (t = "scrollWidth")),
                        (s !== E && ((s !== L && s !== D) || a !== b)) || ((v = S), (p = (p - ((e && i === y && y.visualViewport ? y.visualViewport.height : i[n]) - r.height)) * (u ? 1 : -1))),
                        (s !== L && ((s !== E && s !== S) || a !== b)) || ((m = D), (h = (h - ((e && i === y && y.visualViewport ? y.visualViewport.width : i[t]) - r.width)) * (u ? 1 : -1)))),
                    Object.assign({ position: c }, d && pt)),
                e = !0 === f ? ((s = (n = { x: h, y: p }).x), (n = n.y), (a = window.devicePixelRatio || 1), { x: et(s * a) / a || 0, y: et(n * a) / a || 0 }) : { x: h, y: p };
            return (
                (h = e.x),
                (p = e.y),
                u
                    ? Object.assign({}, o, (((i = {})[v] = l ? "0" : ""), (i[m] = g ? "0" : ""), (i.transform = (y.devicePixelRatio || 1) <= 1 ? "translate(" + h + "px, " + p + "px)" : "translate3d(" + h + "px, " + p + "px, 0)"), i))
                    : Object.assign({}, o, (((t = {})[v] = l ? p + "px" : ""), (t[m] = g ? h + "px" : ""), (t.transform = ""), t))
            );
        }
        var mt = {
                name: "computeStyles",
                ...
                fn: function (e) {
                    var t = e.state,
                        ...
                        n = { placement: j(t.placement), variation: ht(t.placement), popper: t.elements.popper, popperRect: t.rects.popper, gpuAcceleration: n, isFixed: "fixed" === t.options.strategy };
                    null != t.modifiersData.popperOffsets &&
                        (t.styles.popper = Object.assign({}, t.styles.popper, gt(Object.assign({}, n, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: i, roundOffsets: e })))),
                        null != t.modifiersData.arrow && (t.styles.arrow = Object.assign({}, t.styles.arrow, gt(Object.assign({}, n, { offsets: t.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: e })))),
        ...
        function St(e, t) {
            return t === Re
                ? Et(
                      ...
                      { width: r, height: o, x: s + kt(n), y: a })
                  )
                : Ge(t)
                ? (((r = tt((i = t))).top = r.top + i.clientTop),
                ...
                : Et(
                      ...
                      (t = A(s.scrollWidth, s.clientWidth, a ? a.scrollWidth : 0, a ? a.clientWidth : 0)),
                      (e = A(s.scrollHeight, s.clientHeight, a ? a.scrollHeight : 0, a ? a.clientHeight : 0)),
                      (o = -n.scrollLeft + kt(o)),
                      (n = -n.scrollTop),
                      "rtl" === x(a || s).direction && (o += A(s.clientWidth, a ? a.clientWidth : 0) - t),
        ...
        function Dt(n, e, t) {
            var i,
                o =
                    "clippingParents" === e
                        ? ((r = At(ot((o = n)))),
                          Ge((i = 0 <= ["absolute", "fixed"].indexOf(x(o).position) && w(o) ? st(o) : o))
                              ? r.filter(function (e) {
        ...
        function Ot(e, t) {
            var i,
                ...
                r = Lt({ reference: o, element: l, strategy: "absolute", placement: n }),
                l = Et(Object.assign({}, l, r)),
                r = s === Be ? l : o,
                c = { top: a.top - r.top + t.top, bottom: r.bottom - a.bottom + t.bottom, left: a.left - r.left + t.left, right: r.right - a.right + t.right },
                ...
                if (!d.modifiersData[e]._skip) {
                    for (
                                    ...
                                    j(t) === He
                                        ? ((n = d),
                                          ...
                                          (u = (i =
                                              ...
                                              return (e[t] = Ot(n, { placement: t, boundary: o, rootBoundary: r, padding: s })[j(t)]), e;
                                          }, {})),
                        ...
                        var _ = a[b],
                            ...
                            T = 0 <= [E, S].indexOf(w),
                            k = T ? "width" : "height",
                            C = Ot(d, { placement: _, boundary: h, rootBoundary: p, altBoundary: r, padding: f }),
                            T = T ? (x ? D : L) : x ? S : E,
                            x = (l[k] > c[k] && (T = _t(T)), _t(T)),
                            k = [];
                        if (
                            (i && k.push(C[w] <= 0),
                            o && k.push(C[T] <= 0, C[x] <= 0),
                            k.every(function (e) {
                                return e;
                            }))
                        ) {
        ...
        var Pt = {
            ...
            fn: function (e) {
                var t = e.state,
                    ...
                    s = Ot(t, { altBoundary: !0 }),
                    r = jt(r, n),
                    n = jt(s, i, o),
                    s = It(r),
                    i = It(n);
                (t.modifiersData[e] = { referenceClippingOffsets: r, popperEscapeOffsets: n, isReferenceHidden: s, hasPopperEscaped: i }),
        ...
        var Ht = {
            ...
            fn: function (e) {
                var t = e.state,
                    e = e.name;
                t.modifiersData[e] = Lt({ reference: t.rects.reference, element: t.rects.popper, strategy: "absolute", placement: t.placement });
            },
            data: {},
        };
        var qt = {
            ...
            fn: function (e) {
                var t,
                    ...
                    p = Ot(u, { boundary: p, rootBoundary: g, padding: v, altBoundary: m }),
                    g = j(u.placement),
                    m = !(v = ht(u.placement)),
                    b = at(g),
                    _ = "x" === b ? "y" : "x",
                ...
                w &&
                    (f &&
                        ...
                        (n = (i = u.modifiersData["arrow#persistent"] ? u.modifiersData["arrow#persistent"].padding : ct())[n]),
                        (i = i[c]),
                        (c = lt(0, x[f], r[f])),
                        (r = m ? x[f] / 2 - t - c - n - d.mainAxis : o - c - n - d.mainAxis),
                        (o = m ? -x[f] / 2 + t + c + i + d.mainAxis : v + c + i + d.mainAxis),
                        (m = (n = u.elements.arrow && st(u.elements.arrow)) ? ("y" === b ? n.clientTop || 0 : n.clientLeft || 0) : 0),
                        (v = a + o - (t = null != (f = null == k ? void 0 : k[b]) ? f : 0)),
                        (c = lt(y ? Ze(s, a + r - t - m) : s, a, y ? A(l, v) : l)),
                        (w[b] = c),
                        (C[b] = c - a)),
                    h &&
                        ((i = "y" == _ ? "height" : "width"),
                        ...
                        (s = r ? o : n - x[i] - T[i] - m + d.altAxis),
                        (v = r ? n + x[i] + T[i] - m - d.altAxis : f),
                        (a = y && r ? ((l = lt((l = s), n, (c = v))), c < l ? c : l) : lt(y ? s : o, n, y ? v : f)),
                        (w[_] = a),
                        (C[_] = a - n)),
                    (u.modifiersData[e] = C));
            },
        ...
        function Rt(e, t, n) {
            ...
            return (
                (!i && n) ||
                    (("body" === v(t) && !Ct(r)) || (e = (i = t) !== _(i) && w(i) ? { scrollLeft: i.scrollLeft, scrollTop: i.scrollTop } : Tt(i)), w(t) ? (((a = tt(t, !0)).x += t.clientLeft), (a.y += t.clientTop)) : r && (a.x = kt(r))),
        ...
        function zt(e) {
            ...
            return function (i, o, t) {
                ...
                var n,
                    r,
                    s = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, Ft, f), modifiersData: {}, elements: { reference: i, popper: o }, attributes: {}, styles: {} },
                    a = [],
                    l = !1,
                    c = {
                        state: s,
                        setOptions: function (e) {
                            var n,
                                ...
                                e =
                                    ...
                                    (s.scrollParents = { reference: Ge(i) ? At(i) : i.contextElement ? At(i.contextElement) : [], popper: At(o) }),
                        ...
                        forceUpdate: function () {
                            if (!l) {
                                var e = s.elements,
                                    ...
                                    e = e.popper;
                                if (Wt(t, e)) {
                                    (s.rects = { reference: Rt(t, st(e), "fixed" === s.options.strategy), popper: nt(e) }),
                                        (s.reset = !1),
                                    ...
                                    for (var n, i, o, r = 0; r < s.orderedModifiers.length; r++)
                                        !0 === s.reset
                                            ? ((s.reset = !1), (r = -1))
                                            : ((n = (o = s.orderedModifiers[r]).fn), (i = o.options), (o = o.name), "function" == typeof n && (s = n({ state: s, options: void 0 === i ? {} : i, name: o, instance: c }) || s));
                                }
                            }
                        },
                        update:
        ...
        var $t = zt({ defaultModifiers: [yt, Ht, mt, Je, Mt, Nt, qt, ft, Pt] });
                ...
                Object.defineProperty(
                    {
                        ...
                        createPopperBase: zt(),
                        createPopper: $t,
                        createPopperLite: zt({ defaultModifiers: [yt, Ht, mt, Je] }),
                        top: E,
                        bottom: S,
                        right: D,
                        left: L,
        ...
        const Yt = "show",
            ...
            rn = { autoClose: "(boolean|string)", boundary: "(string|element)", display: "string", offset: "(array|string|function)", popperConfig: "(null|object|function)", reference: "(string|element|object)" };
        class k extends t {
            constructor(e, t) {
            ...
            show() {
                if (!a(this._element) && !this._isShown()) {
                    ...
                    if (!t.defaultPrevented) {
                        if ((this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav"))) for (const n of [].concat(...document.body.children)) y.on(n, "mouseover", W);
            ...
            _completeHide(e) {
                ...
                if (!t.defaultPrevented) {
                    if ("ontouchstart" in document.documentElement) for (const n of [].concat(...document.body.children)) y.off(n, "mouseover", W);
            ...
            _getPopperConfig() {
                ...
                return (
                    (!this._inNavbar && "static" !== this._config.display) || (d.setDataAttribute(this._menu, "popper", "static"), (e.modifiers = [{ name: "applyStyles", enabled: !1 }])),
        ...
        y.on(document, Xe, Qt, k.dataApiKeydownHandler),
            y.on(document, Xe, Gt, k.dataApiKeydownHandler),
            y.on(document, Ve, k.clearMenus),
            y.on(document, "keyup.bs.dropdown.data-api", k.clearMenus),
            y.on(document, Ve, Qt, function (e) {
        ...
        const dn = "backdrop",
            fn = "mousedown.bs." + dn,
            hn = { className: "modal-backdrop", clickCallback: null, isAnimated: !1, isVisible: !0, rootElement: "body" },
            pn = { className: "string", clickCallback: "(function|null)", isAnimated: "boolean", isVisible: "boolean", rootElement: "(element|string)" };
        class gn extends fe {
            constructor(e) {
        ...
        const mn = ".bs.focustrap",
            vn = (mn, mn, "backward"),
            yn = { autofocus: !0, trapElement: null },
            bn = { autofocus: "boolean", trapElement: "element" };
        class _n extends fe {
            constructor(e) {
        ...
        const Tn = "modal-open",
            kn = "modal-static";
        const Cn = { backdrop: !0, focus: !0, keyboard: !0 },
            An = { backdrop: "(boolean|string)", focus: "boolean", keyboard: "boolean" };
        class En extends t {
            constructor(e, t) {
                super(e, t),
            ...
            show(e) {
                this._isShown ||
                    ...
                    y.trigger(this._element, xn, { relatedTarget: e }).defaultPrevented ||
                    ((this._isShown = !0), (this._isTransitioning = !0), this._scrollBar.hide(), document.body.classList.add(Tn), this._adjustDialog(), this._backdrop.show(() => this._showElement(e)));
            }
            hide() {
                !this._isShown ||
                    this._isTransitioning ||
        ...
        const Nn = { backdrop: !0, keyboard: !0, scroll: !1 },
            jn = { backdrop: "(boolean|string)", keyboard: "boolean", scroll: "boolean" };
        class I extends t {
            constructor(e, t) {
            ...
            show(e) {
                this._isShown ||
                    y.trigger(this._element, "show.bs.offcanvas", { relatedTarget: e }).defaultPrevented ||
                    ((this._isShown = !0),
                    this._backdrop.show(),
                    ...
                    this._queueCallback(
                        () => {
                            (this._config.scroll && !this._config.backdrop) || this._focustrap.activate(),
                                ...
                                y.trigger(this._element, "shown.bs.offcanvas", { relatedTarget: e });
                        },
                        this._element,
                        !0
                    ));
        ...
        const qn = { allowList: Ye, content: {}, extraClass: "", html: !1, sanitize: !0, sanitizeFn: null, template: "<div></div>" },
            Rn = { allowList: "object", content: "object", extraClass: "(string|function)", html: "boolean", sanitize: "boolean", sanitizeFn: "(null|function)", template: "string" },
            Bn = { entry: "(string|element|function|null)", selector: "(string|element)" };
        class Fn extends fe {
            constructor(e) {
            ...
            _checkContent(e) {
                for (var [t, n] of Object.entries(e)) super._typeCheckConfig({ selector: t, entry: n }, Bn);
            }
            _setContent(e, t, n) {
        ...
        class Kn extends t {
            ...
            show() {
                ...
                if (this._isWithContent() && this._isEnabled) {
                    ...
                    if (!e.defaultPrevented && t) {
                        ...
                        if (
                            (this._element.ownerDocument.documentElement.contains(this.tip) || (o.append(i), y.trigger(this._element, this.constructor.eventName("inserted"))),
            ...
            hide() {
                if (this._isShown()) {
                    ...
                    if (!e.defaultPrevented) {
                        ...
                        if ((t.classList.remove($n), "ontouchstart" in document.documentElement)) for (const n of [].concat(...document.body.children)) y.off(n, "mouseover", W);
            ...
            _getTemplateFactory(e) {
                return (
                    this._templateFactory ? this._templateFactory.changeContent(e) : (this._templateFactory = new Fn({ ...this._config, content: e, extraClass: this._resolvePossibleFunction(this._config.customClass) })),
            ...
            _setListeners() {
                ...
                for (const n of this._config.trigger.split(" "))
                    "click" === n
                        ? y.on(this._element, this.constructor.eventName("click"), this._config.selector, (e) => this.toggle(e))
                        : "manual" !== n &&
                ...
                (this._hideModalHandler = () => {
                    ...
                    y.on(this._element.closest(".modal"), Vn, this._hideModalHandler),
        ...
        const Jn = {
            ...
            Zn = { ...Kn.DefaultType, content: "(null|string|element|function)" };
        class ei extends Kn {
            static get Default() {
                return Jn;
            }
        ...
        const ni = "active",
            ii = "[href]";
        const oi = { offset: null, rootMargin: "0px 0px -25%", smoothScroll: !1, target: null },
            ri = { offset: "(number|null)", rootMargin: "string", smoothScroll: "boolean", target: "element" };
        class si extends t {
            constructor(e, t) {
                super(e, t),
            ...
            _maybeEnableSmoothScroll() {
                this._config.smoothScroll &&
                    (y.off(this._config.target, ti),
                    y.on(this._config.target, ti, ii, (e) => {
                        var t = this._observableSections.get(e.target.hash);
                        if (t) {
                            e.preventDefault();
                            const n = this._rootElement || window;
                            e = t.offsetTop - this._element.offsetTop;
                            n.scrollTo ? n.scrollTo({ top: e, behavior: "smooth" }) : (n.scrollTop = e);
                        }
                    }));
            }
            _getNewObserver() {
                var e = { root: this._rootElement, threshold: [0.1, 0.5, 1], rootMargin: this._getRootMargin() };
            ...
            _process(e) {
                this._activeTarget !== e && (this._clearActiveClass(this._config.target), (this._activeTarget = e).classList.add(ni), this._activateParents(e), y.trigger(this._element, "activate.bs.scrollspy", { relatedTarget: e }));
            }
            _activateParents(e) {
                if (e.classList.contains("dropdown-item")) f.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(ni);
                else for (const t of f.parents(e, ".nav, .list-group")) for (const n of f.prev(t, ".nav-link, .nav-item > .nav-link, .list-group-item")) n.classList.add(ni);
            }
            _clearActiveClass(e) {
        ...
        class di extends t {
            constructor(e) {
                super(e),
                    ...
                    this._parent && (this._setInitialAttributes(this._parent, this._getChildren()), y.on(this._element, "keydown.bs.tab", (e) => this._keydown(e)));
            }
            static get NAME() {
                return "tab";
            }
            show() {
                ...
                this._elemIsActive(n) ||
                    ((t = (e = this._getActiveElem()) ? y.trigger(e, "hide.bs.tab", { relatedTarget: n }) : null),
                    y.trigger(n, "show.bs.tab", { relatedTarget: e }).defaultPrevented || (t && t.defaultPrevented) || (this._deactivate(e, n), this._activate(n, e)));
            }
            _activate(e, t) {
                e &&
                    (e.classList.add(P),
                    ...
                    this._queueCallback(
                        () => {
                            "tab" !== e.getAttribute("role")
                                ? e.classList.add(ci)
                                : (e.focus(), e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), this._toggleDropDown(e, !0), y.trigger(e, "shown.bs.tab", { relatedTarget: t }));
                        },
                        e,
                    ...
                    this._queueCallback(
                        () => {
                            "tab" !== e.getAttribute("role")
                                ...
                                : (e.setAttribute("aria-selected", !1), e.setAttribute("tabindex", "-1"), this._toggleDropDown(e, !1), y.trigger(e, "hidden.bs.tab", { relatedTarget: t }));
                        },
                        e,
                        e.classList.contains("fade")
                    ));
            ...
            _toggleDropDown(e, i) {
                ...
                o.classList.contains("dropdown") &&
                    ...
                    e(".dropdown-menu", ci),
                    e(".dropdown-item", P),
                    o.setAttribute("aria-expanded", i));
            }
        ...
        return he(mi), e(mi), { Alert: pe, Button: me, Carousel: Le, Collapse: Me, Dropdown: k, Modal: En, Offcanvas: I, Popover: ei, ScrollSpy: si, Tab: di, Toast: mi, Tooltip: Kn };
    }),
    (function (e) {
        "use strict";
        ...
        "use strict";
        function i(e, t) {
            (this.value = { h: 0, s: 0, b: 0, a: 1 }), (this.origFormat = null), t && a.extend(this.colors, t), e && (void 0 !== e.toLowerCase ? this.setColor((e += "")) : void 0 !== e.h && (this.value = e));
        }
        function r(e, t) {
            var n;
            (this.element = a(e).addClass("colorpicker-element")),
                ...
                (this.color = new i(!1 !== this.options.color ? this.options.color : this.getValue(), this.options.colorSelectors)),
                (this.format = !1 !== this.options.format ? this.options.format : this.color.origFormat),
                !1 !== this.options.color && (this.updateInput(this.color), this.updateData(this.color)),
                (this.picker = a(this.options.template)),
                this.options.customClass && this.picker.addClass(this.options.customClass),
                ...
                ("rgba" !== this.format && "hsla" !== this.format && !1 !== this.options.format) || this.picker.addClass("colorpicker-with-alpha"),
                "right" === this.options.align && this.picker.addClass("colorpicker-right"),
                !0 === this.options.inline && this.picker.addClass("colorpicker-no-arrow"),
                ...
                !1 !== this.input &&
                    ...
                    !1 === this.component && this.element.on({ "focus.colorpicker": a.proxy(this.show, this) }),
                    !1 === this.options.inline && this.element.on({ "focusout.colorpicker": a.proxy(this.hide, this) })),
                !1 !== this.component && this.component.on({ "click.colorpicker": a.proxy(this.show, this) }),
                !1 === this.input && !1 === this.component && this.element.on({ "click.colorpicker": a.proxy(this.show, this) }),
                !1 !== this.input && !1 !== this.component && "color" === this.input.attr("type") && this.input.on({ "click.colorpicker": a.proxy(this.show, this), "focus.colorpicker": a.proxy(this.show, this) }),
                this.update(),
                a(
                    a.proxy(function () {
        ...
        var o = {
            horizontal: !(i.prototype = {
                ...
                setColor: function (e) {
                    (e = e.toLowerCase().trim()) && (this.isTransparent(e) ? (this.value = { h: 0, s: 0, b: 0, a: 0 }) : (this.value = this.stringToHSB(e) || { h: 0, s: 0, b: 0, a: 1 }));
                },
                ...
                toRGB: function (e, t, n, i) {
                    ...
                    return (
                        ...
                        (e = ((e *= 360) % 360) / 60),
                        (o = r = t = n - (n = n * t)),
                        (o += [n, (s = n * (1 - Math.abs((e % 2) - 1))), 0, 0, s, n][(e = ~~e)]),
                        (r += [s, n, n, s, 0, 0][e]),
                        (t += [0, 0, s, n, n, s][e]),
                        { r: Math.round(255 * o), g: Math.round(255 * r), b: Math.round(255 * t), a: i || this.value.a }
                    );
                },
                ...
                toHSL: function (e, t, n, i) {
                    ...
                    var o = (2 - t) * n,
                        t = t * n;
                    return (t /= 0 < o && o <= 1 ? o : 2 - o), (o /= 2), 1 < t && (t = 1), { h: isNaN(e) ? 0 : e, s: isNaN(t) ? 0 : t, l: isNaN(o) ? 0 : o, a: isNaN(i) ? 0 : i };
                },
                ...
                RGBtoHSB: function (e, t, n, i) {
                    ...
                    return (
                        ...
                        (t /= 255),
                        (n /= 255),
                        (o = 0 == (s = (r = Math.max(e, t, n)) - Math.min(e, t, n)) ? 0 : s / r),
                        { h: this._sanitizeNumber(((((0 == s ? null : r === e ? (t - n) / s : r === t ? (n - e) / s + 2 : (e - t) / s + 4) + 360) % 6) * 60) / 360), s: o, b: r, a: this._sanitizeNumber(i) }
                    );
                },
            ...
            (r.prototype = {
                ...
                reposition: function () {
                    ...
                    var e = this.container && this.container[0] !== document.body ? "position" : "offset",
                        ...
                        e = t[e]();
                    "right" === this.options.align && (e.left -= this.picker.outerWidth() - t.outerWidth()), this.picker.css({ top: e.top + t.outerHeight(), left: e.left });
                },
                show: function (e) {
                    ...
                    this.picker.addClass("colorpicker-visible").removeClass("colorpicker-hidden"),
                        ...
                        !e || (this.hasInput() && "color" !== this.input.attr("type")) || (e.stopPropagation && e.preventDefault && (e.stopPropagation(), e.preventDefault())),
                        (!this.component && this.input) || !1 !== this.options.inline || a(window.document).on({ "mousedown.colorpicker": a.proxy(this.hide, this) }),
                ...
                updateInput: function (e) {
                    ...
                    return (
                        ...
                        !1 !== this.input && (this.options.colorSelectors && ((t = new i(e, this.options.colorSelectors).toAlias()), void 0 !== this.options.colorSelectors[t] && (e = t)), this.input.prop("value", e)),
                        e
                    );
                },
                updatePicker: function (e) {
                    ...
                    if (0 !== n.length)
                        return (
                            ...
                            n.eq(0).css({ top: t.saturation.maxTop - this.color.value.b * t.saturation.maxTop, left: this.color.value.s * t.saturation.maxLeft }),
                ...
                updateComponent: function (e) {
                    var t;
                    return (e = e || this.color.toString(this.format)), !1 !== this.component && (0 < (t = this.component.find("i").eq(0)).length ? t : this.component).css({ backgroundColor: e }), e;
                },
                update: function (e) {
                    var t;
                ...
                setValue: function (e) {
                    (this.color = new i(e, this.options.colorSelectors)), this.update(!0), this.element.trigger({ type: "changeColor", color: this.color, value: e });
                },
                getValue: function (e) {
                    var t;
                ...
                mousemove: function (e) {
                    ...
                    return (
                        ...
                        this.currentSlider.callTop && this.color[this.currentSlider.callTop].call(this.color, e / this.currentSlider.maxTop),
                        "setAlpha" === this.currentSlider.callTop &&
                            !1 === this.options.format &&
                            (1 !== this.color.value.a ? ((this.format = "rgba"), (this.color.origFormat = "rgba")) : ((this.format = "hex"), (this.color.origFormat = "hex"))),
                        this.update(!0),
                ...
                mouseup: function (e) {
                    return (
                        e.stopPropagation(),
                        e.preventDefault(),
                        a(document).off({ "mousemove.colorpicker": this.mousemove, "touchmove.colorpicker": this.mousemove, "mouseup.colorpicker": this.mouseup, "touchend.colorpicker": this.mouseup }),
                        !1
                    );
                },
                change: function (e) {
                ...
                keyup: function (e) {
                    38 === e.keyCode
                        ? (this.color.value.a < 1 && (this.color.value.a = Math.round(100 * (this.color.value.a + 0.01)) / 100), this.update(!0))
                        : 40 === e.keyCode
                        ? (0 < this.color.value.a && (this.color.value.a = Math.round(100 * (this.color.value.a - 0.01)) / 100), this.update(!0))
                        : ((this.color = new i(this.input.val(), this.options.colorSelectors)),
                          this.color.origFormat && !1 === this.options.format && (this.format = this.color.origFormat),
                          !1 !== this.getValue(!1) && (this.updateData(), this.updateComponent(), this.updatePicker())),
                        this.element.trigger({ type: "changeColor", color: this.color, value: this.input.val() });
                },
            }),
            (a.colorpicker = r),
